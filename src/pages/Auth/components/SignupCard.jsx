const SignupCard = () => {
  return (
    <div className="bg-surface-container-lowest rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.04)] p-8 md:p-12 flex flex-col items-center text-center">
      ...
      <button className="w-full bg-kakao-yellow hover:bg-[#F7D600] text-black font-semibold py-4 px-6 rounded-full flex items-center justify-center gap-3 transition-all active:scale-[0.98] shadow-md mb-6">
